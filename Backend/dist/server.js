...
app.get('/api/bills', isAuthenticated, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (startDate) {
        ...
        whereConditions.push(`b.created_at AT TIME ZONE 'Asia/Bangkok' >= $${queryParams.length}`);
    }
    if (endDate) {
...
app.get("/api/financial-summary-fast-version", isAuthenticated, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (lottoDate && lottoDate !== 'all' && lottoDate !== '') {
            ...
            // 🟢 เปลี่ยนมาใช้ b.created_at + เวลาไทย
            betConditions.push(`b.created_at AT TIME ZONE 'Asia/Bangkok' BETWEEN $${betParams.length + 1} AND $${betParams.length + 2}`);
            betParams.push(`${startDate} 00:00:00`, `${endDate} 23:59:59`);
        }
        else {
            // 🟢 เปลี่ยนมาใช้ b.created_at + เวลาไทย
            betConditions.push(`b.created_at AT TIME ZONE 'Asia/Bangkok' BETWEEN $${betParams.length + 1} AND $${betParams.length + 2}`);
...
app.get("/api/prize-check/lotto-names", isAuthenticated, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const loggedInUser = req.user;
    ...
    try {
        ...
        `;
        const result = yield db.query(sql, queryParams);
...
app.get("/api/prize-check/all-items", isAuthenticated, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Filter วันที่
    // whereConditions.push(`b.created_at BETWEEN $${paramIndex++} AND $${paramIndex++}`);
    whereConditions.push(`b.created_at AT TIME ZONE 'Asia/Bangkok' BETWEEN $${paramIndex++} AND $${paramIndex++}`);
    queryParams.push(`${startDate} 00:00:00`, `${endDate} 23:59:59`);
...
app.get("/api/winning-report", isAuthenticated, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (lottoDate && lottoDate !== 'all') {
            ...
            conditions.push(`b.created_at AT TIME ZONE 'Asia/Bangkok' BETWEEN $${queryParams.length + 1} AND $${queryParams.length + 2}`);
            queryParams.push(`${startDate} 00:00:00`, `${endDate} 23:59:59`);
        }
        if (loggedInUser.role === 'owner' || loggedInUser.role === 'admin') {
            if (username && username !== 'all' && username !== '') {
