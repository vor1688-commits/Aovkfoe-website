...
const AccountPage: React.FC = () => {
    ...
    // State for Pagination of "Recent Bills Table"
    ...
    // State for Pagination of "Winning Items Table"
...
        options={{ responsive: true, maintainAspectRatio: false, plugins: { legend: { display: false }, tooltip: { backgroundColor: "rgba(0, 0, 0, 0.8)", callbacks: { label: (c: any) => `${c.label}: ${c.raw.toLocaleString()} บาท`, }, }, }, }}
      />
    </div>
