...
const AccountPage: React.FC = () => {
  ...
  const fetchAllData = useCallback(async () => {
    ...
    const summaryRequest = api.get<SummaryApiResponse>(`/api/financial-summary-fast-version?${summaryParams.toString()}`);
...
const {
  ...
  // --- ✅ [จุดที่แก้ไข] ---
  // แก้ไขสูตรคำนวณกำไรให้ถูกต้องเป็น: ยอดถูกรางวัล - ยอดแทงทั้งหมด
